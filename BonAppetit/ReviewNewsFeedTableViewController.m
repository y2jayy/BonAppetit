...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"FoodFeedToUserReviewsSegue"]) {
        UserReviewsCollectionViewController *controller = (UserReviewsCollectionViewController *)segue.destinationViewController;
        controller.userId = [NSString stringWithFormat:@"%d", 45];
    }
}
